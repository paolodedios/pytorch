...
if(INTERN_BUILD_ATEN_OPS)
  ...
  if(CXX_SVE_256_FOUND)
    ...
    if("${CMAKE_C_COMPILER_ID}" MATCHES "Clang")
      list(APPEND CPU_CAPABILITY_FLAGS "${OPT_FLAG} -O2 -march=armv8.2-a+sve+bf16 -D__ARM_FEATURE_BF16 -DCPU_CAPABILITY_SVE -msve-vector-bits=256")
    else()
      list(APPEND CPU_CAPABILITY_FLAGS "${OPT_FLAG} -march=armv8.2-a+sve+bf16 -D__ARM_FEATURE_BF16 -DCPU_CAPABILITY_SVE -msve-vector-bits=256")
    endif()
