...
function(caffe2_print_configuration_summary)
  ...
  if(${USE_ROCM})
    message(STATUS "    ROCM_VERSION                  : ${ROCM_VERSION_DEV}")
    message(STATUS "    USE_FLASH_ATTENTION           : ${USE_FLASH_ATTENTION}")
    message(STATUS "    USE_MEM_EFF_ATTENTION         : ${USE_MEM_EFF_ATTENTION}")
  ...
  message(STATUS "  USE_MSLK              : ${USE_MSLK}")
  ...
  message(STATUS "  CAN_COMPILE_METAL_40  : ${CAN_COMPILE_METAL_40}")
  ...
  if(${USE_NCCL})
    ...
    message(STATUS "    USE_NCCL_M2N        : ${USE_NCCL_M2N}")
    if(${USE_NCCL_M2N})
      message(STATUS "    USE_STATIC_NCCL_M2N : ${USE_STATIC_NCCL_M2N}")
    endif()
  endif()
  if(${USE_ROCM})
    message(STATUS "  Found ROCSHMEM         : ${ROCSHMEM_INCLUDE_DIR}")
  else()
