...
// SVE enables acceleration of further operations

#define VEC_INT_SVE_OPS(vl, bit)                                        \
  ...
  inline Vectorized<int##bit##_t> Vectorized<int##bit##_t>::loadu(      \
    ...
    return svget_neonq(                                                 \
        svld1_s##bit(pg, reinterpret_cast<const int##bit##_t*>(ptr)));  \
  }                                                                     \
  ...
  inline Vectorized<int##bit##_t> Vectorized<int##bit##_t>::set(        \
      const Vectorized<int##bit##_t>& a,                                \
      const Vectorized<int##bit##_t>& b,                                \
      int64_t count) {                                                  \
    if (count == 0) {                                                   \
    ...
    return svget_neonq(svsel_s##bit(                                    \
        svwhilelt_b##bit(0ull, count),                                  \
        svset_neonq(svundef_s##bit(), b.values),                        \
        svset_neonq(svundef_s##bit(), a.values)));                      \
  }

VEC_INT_SVE_OPS(2, 64)
VEC_INT_SVE_OPS(4, 32)
VEC_INT_SVE_OPS(8, 16)
VEC_INT_SVE_OPS(16, 8)

template <>
Vectorized<int64_t> inline operator*(
    const Vectorized<int64_t>& a,
    const Vectorized<int64_t>& b) {
  return svget_neonq(svmul_s64_x(
      svptrue_b8(),
      svset_neonq(svundef_s64(), a),
      svset_neonq(svundef_s64(), b)));
}
...
Vectorized<int64_t> inline operator/(
    const Vectorized<int64_t>& a,
    const Vectorized<int64_t>& b) {
  return svget_neonq(svdiv_s64_x(
      svptrue_b8(),
      svset_neonq(svundef_s64(), a),
      svset_neonq(svundef_s64(), b)));
}
...
Vectorized<int32_t> inline operator/(
    const Vectorized<int32_t>& a,
    const Vectorized<int32_t>& b) {
  return svget_neonq(svdiv_s32_x(
      svptrue_b8(),
      svset_neonq(svundef_s32(), a),
      svset_neonq(svundef_s32(), b)));
}

inline int64_t Vectorized<int64_t>::reduce_max() const {
  return svmaxv_s64(svptrue_b8(), svset_neonq(svundef_s64(), values));
}
...
Vectorized<int64_t> inline minimum(
    const Vectorized<int64_t>& a,
    const Vectorized<int64_t>& b) {
  return svget_neonq(svmin_s64_x(
      svptrue_b8(),
      svset_neonq(svundef_s64(), a),
      svset_neonq(svundef_s64(), b)));
}
...
Vectorized<int64_t> inline maximum(
    const Vectorized<int64_t>& a,
    const Vectorized<int64_t>& b) {
  return svget_neonq(svmax_s64_x(
      svptrue_b8(),
      svset_neonq(svundef_s64(), a),
      svset_neonq(svundef_s64(), b)));
}
...
inline Vectorized<int64_t> Vectorized<int64_t>::arange(
  ...
  const auto step_sizes = svindex_s64(0, 1);
  return svget_neonq(svmla_s64_x(
      svptrue_b8(),
      svset_neonq(svundef_s64(), base_vec),
      step_sizes,
      svset_neonq(svundef_s64(), step_vec)));
}
...
inline Vectorized<int32_t> Vectorized<int32_t>::arange(
  ...
  const Vectorized<int32_t> step_sizes = svget_neonq(svindex_s32(0, 1));
...
inline Vectorized<int16_t> Vectorized<int16_t>::arange(
  ...
  const Vectorized<int16_t> step_sizes = svget_neonq(svindex_s16(0, 1));
...
inline Vectorized<int8_t> Vectorized<int8_t>::arange(int8_t base, step_t step) {
  ...
  const Vectorized<int8_t> step_sizes = svget_neonq(svindex_s8(0, 1));
...
Vectorized<int64_t> inline operator<<(
    const Vectorized<int64_t>& a,
    const Vectorized<int64_t>& b) {
  return svget_neonq(svlsl_s64_x(
      svptrue_b8(),
      svset_neonq(svundef_s64(), a),
      svset_neonq(svundef_u64(), vreinterpretq_u64_s64(b))));
}
...
Vectorized<int32_t> inline operator<<(
    const Vectorized<int32_t>& a,
    const Vectorized<int32_t>& b) {
  return svget_neonq(svlsl_s32_x(
      svptrue_b8(),
      svset_neonq(svundef_s32(), a),
      svset_neonq(svundef_u32(), vreinterpretq_u32_s32(b))));
}
...
Vectorized<int16_t> inline operator<<(
    const Vectorized<int16_t>& a,
    const Vectorized<int16_t>& b) {
  return svget_neonq(svlsl_s16_x(
      svptrue_b8(),
      svset_neonq(svundef_s16(), a),
      svset_neonq(svundef_u16(), vreinterpretq_u16_s16(b))));
}
...
Vectorized<int8_t> inline operator<<(
    const Vectorized<int8_t>& a,
    const Vectorized<int8_t>& b) {
  return svget_neonq(svlsl_s8_x(
      svptrue_b8(),
      svset_neonq(svundef_s8(), a),
...
Vectorized<int64_t> inline operator>>(
    const Vectorized<int64_t>& a,
    const Vectorized<int64_t>& b) {
  return svget_neonq(svasr_s64_x(
      svptrue_b8(),
      svset_neonq(svundef_s64(), a),
      svset_neonq(svundef_u64(), vreinterpretq_u64_s64(b))));
}
...
Vectorized<int32_t> inline operator>>(
    const Vectorized<int32_t>& a,
    const Vectorized<int32_t>& b) {
  return svget_neonq(svasr_s32_x(
      svptrue_b8(),
      svset_neonq(svundef_s32(), a),
      svset_neonq(svundef_u32(), vreinterpretq_u32_s32(b))));
}
...
Vectorized<int16_t> inline operator>>(
    const Vectorized<int16_t>& a,
    const Vectorized<int16_t>& b) {
  return svget_neonq(svasr_s16_x(
      svptrue_b8(),
      svset_neonq(svundef_s16(), a),
      svset_neonq(svundef_u16(), vreinterpretq_u16_s16(b))));
}
...
#endif // defined(__ARM_TARGET_SVE)
