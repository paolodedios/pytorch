...
class Vectorized<c10::Half> : public Vectorized16<
 ...
 public:
  ...
  bool has_inf_nan() const {
    return svptest_any(
        ptrue, svcmpuo_f16(ptrue, svset_neonq(svundef_f16(), vsubq_f16(values, values)), ZERO_F16));
  }
  ...
  Vectorized<c10::Half> rsqrt() const {
    return Vectorized<c10::Half>(vrsqrteq_f16(values));
  }
...
inline Vectorized<c10::Half> Vectorized<c10::Half>::eq(
  ...
  return svreinterpret_f16_u16(svand_n_u16_x(ptrue, svreinterpret_u16_f16(*this == other), 1));
}
