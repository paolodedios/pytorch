...
FOR %%v IN (%DESIRED_PYTHON%) DO (
    ...
    if "%%v" == "3.13t" call conda create -n py!PYTHON_VERSION_STR! -y -q -c=conda-forge numpy=2.1.2 pyyaml boto3 cmake ninja typing_extensions setuptools=72.1.0 python=3.13 python-gil
