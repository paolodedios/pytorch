...
if "%DESIRED_PYTHON%" == "3.15t" %PYTHON_EXEC% -m pip install numpy==2.5.0 cmake
if "%DESIRED_PYTHON%" == "3.15" %PYTHON_EXEC% -m pip install numpy==2.5.0 cmake
...
%PYTHON_EXEC% -m pip install boto3 requests ninja typing_extensions setuptools==78.1.1
