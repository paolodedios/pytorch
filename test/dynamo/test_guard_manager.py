...
""",
    ...
    def test_framelocals_guard_config_flag(self):
        ...
        guard_str = str(c1[0].guard_manager)
        self.assertIn(
            "source=L['x'], accessed_by=FrameLocalsGuardAccessor(key='x'",
            guard_str,
        )
    ...
    def test_self_modules_token_plan_candidate_is_segment_aware(self):
        ...
        guard_manager.dict_getitem_manager(
            ...
            {},
            default_mgr_enum,
        ).add_dict_length_check_guard(0, ["len(bad) == 0"], None)
    ...
    def test_self_modules_token_plan_discards_failed_root_tokens(self):
        ...
        guard_manager.dict_getitem_manager(
            ...
            {},
            default_mgr_enum,
        ).add_dict_length_check_guard(0, ["len(mods) == 0"], None)
        guard_manager.dict_getitem_manager(
            "x",
            "L['x']",
            1,
            default_mgr_enum,
        ).add_equals_match_guard(2, ["x == 2"], None)
    ...
    def test_token_plan_fast_hit_skips_self_modules_subtree(self):
        ...
        guard_manager.dict_getitem_manager(
            ...
            {},
            dict_mgr_enum,
        ).add_dict_length_check_guard({}, ["len(block) == 0"], None)
    ...
    def test_token_plan_fast_hit_allows_token_covered_leaf_guard(self):
        ...
        modules_manager.add_dict_version_guard(
            modules, ["dict version matches modules"], None
        )
    ...
    def test_token_plan_fast_hit_preserves_other_guards(self):
        ...
        guard_manager.dict_getitem_manager(
            ...
            1,
            default_mgr_enum,
        ).add_equals_match_guard(1, ["x == 1"], None)
    ...
    def test_token_plan_unsupported_inner_leaf_falls_back(self):
        ...
        guard_manager.dict_getitem_manager(
            ...
            True,
            default_mgr_enum,
        ).add_equals_match_guard(True, ["training == True"], None)
    ...
    def test_token_plan_unsupported_accessor_falls_back(self):
        ...
        guard_manager.dict_getitem_manager(
            ...
            True,
            default_mgr_enum,
        ).add_equals_match_guard(True, ["block[0] == True"], None)
