...
def forward(self, crop_camera_1, mask_1):
    ...
    view_1 = torch.ops.aten.view.default(expand_1, [sym_size_int, sym_size_int_1, sym_size_int_2]);  expand_1 = sym_size_int_1 = None
    bmm = torch.ops.aten.bmm.default(view, view_1);  view = view_1 = None
    view_2 = torch.ops.aten.view.default(bmm, [sym_size_int, 3, sym_size_int_2]);  bmm = None
    mul_12 = sym_size_int * 3
    view_3 = torch.ops.aten.view.default(view_2, [mul_12, sym_size_int_2]);  view_2 = mul_12 = sym_size_int_2 = None
