...
class TestConverter(TestCase):
    ...
    def _check_equal_ts_ep_converter(
        ...
        runtime_inputs: Optional[List[Any]] = [],
    ...
    def test_ts2ep_converter_container_output(self):
        ...
        self._check_equal_ts_ep_converter(MOutputList(), inp, ["script"], runtime_inputs=runtime_inputs)
        self._check_equal_ts_ep_converter(MOutputTuple(), inp, runtime_inputs=runtime_inputs)
        self._check_equal_ts_ep_converter(MOutputDict(), inp, ["script"], runtime_inputs=runtime_inputs)
    ...
    def test_aten_dim(self):
        ...
        inp = (torch.ones(1, 3),)
        self._check_equal_ts_ep_converter(Module(), inp, runtime_inputs=[(torch.ones(1, 5),)])
    ...
    def test_aten_add_t(self):
        ...
        self._check_equal_ts_ep_converter(Module(), inp, ["script"], runtime_inputs=runtime_inputs)
    ...
    def test_aten___is__(self):
        ...
        self._check_equal_ts_ep_converter(Module(), inp, ["script"], runtime_inputs=runtime_inps)
    ...
    def test_ts2ep_with_loop(self):
        ...
        self._check_equal_ts_ep_converter(func1, inp, ["script"], runtime_inputs=runtime_inps)
