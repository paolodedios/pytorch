...
ALLOW_LIST = [
    ...
    ("aten::_cast_Half", datetime.date(9999, 1, 1)),
    ("aten::_cast_Short", datetime.date(9999, 1, 1)),
    ("aten::_cast_Long", datetime.date(9999, 1, 1)),
    ("aten::_cast_Int", datetime.date(9999, 1, 1)),
    ("aten::_cast_Float", datetime.date(9999, 1, 1)),
    ("aten::_cast_Double", datetime.date(9999, 1, 1)),
    ("aten::_cast_Char", datetime.date(9999, 1, 1)),
    ("aten::_cast_Byte", datetime.date(9999, 1, 1)),
]
