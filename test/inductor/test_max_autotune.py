...
from torch._inductor.template_heuristics.triton import (
    SHARED_MEM_ESTIMATION_PADDING_FACTOR,
)
...
class TestTemplateConfigPruning(TestCase):
    ...
    def test_shared_memory_pruning_addmm_tma(
        self,
        dtype: torch.dtype,
        ...
        if use_tma and dtype == torch.float32:
            return
    ...
    @parametrize("mat2_transposed", (False, True))
    @parametrize("use_tma", (False, True))
    def test_shared_memory_pruning_mm_tma(
        self,
        dtype: torch.dtype,
        mat1_transposed: bool,
        mat2_transposed: bool,
    ...
    def run_op_shared_mem_pruning_check(
        ...
        for c in self.gemm_configs:
            ...
            if triton_compilation_fails:
                ...
                self.assertTrue(
                    captured_smem
                    <= smem_estimation * SHARED_MEM_ESTIMATION_PADDING_FACTOR,
