...
class TestDropout(torch.nn.Module):
    ...
    def forward(self, x: torch.Tensor) -> tuple[torch.Tensor, torch.Tensor, torch.Tensor, torch.Tensor]:
        ...
        getitem_4 = split[3]
        getitem_5 = split[4]
        dropout = torch.nn.functional.dropout(getitem_1, p = 0.05, training = True, inplace = False)
        dropout_1 = torch.nn.functional.dropout(getitem_2, p = 0.05, training = True, inplace = False)
        dropout_2 = torch.nn.functional.dropout(getitem_3, p = 0.05, training = True, inplace = False)
        dropout_3 = torch.nn.functional.dropout(getitem_4, p = 0.05, training = True, inplace = False)
        dropout_4 = torch.nn.functional.dropout(getitem_5, p = 0.05, training = True, inplace = False)
