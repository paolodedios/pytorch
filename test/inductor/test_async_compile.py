...
def {{kernel_name}}_precompile(precompile_shapes, precompile_strides, precompile_dtypes, device_index=0):
    with open(_PRECOMPILE_SENTINEL, "w") as f:
        import json
        f.write(json.dumps({"shapes": precompile_shapes, "strides": precompile_strides, "dtypes": precompile_dtypes}))
"""
)
