...
class ConfigTest(TestCase):
    ...
    def assert_versioned_config(self: Self, expected_enabled: bool) -> None:
    ...
    def test_versioned_config_env_var_override(
        ...
        """
        with self.FOO_ENV_VAR_OVERRIDE_LOCK.acquire(timeout=1), patch.dict(
            os.environ,
            {
            ...
            self, "FOO_OSS_DEFAULT", not enabled 
        ):
