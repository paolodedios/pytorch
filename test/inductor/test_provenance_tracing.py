...
class TestProvenanceTracingArtifact(TestCase):
    ...
    def test_triton_kernel_to_post_grad_tracing(self, device="cuda"):
    ...
    def test_triton_kernel_to_post_grad_tracing_cuda(self):
        self.test_triton_kernel_to_post_grad_tracing(device="cuda")

    def test_triton_kernel_to_post_grad_tracing_cpu(self):
        self.test_triton_kernel_to_post_grad_tracing(device="cpu")
