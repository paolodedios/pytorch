...
class AOTInductorTestsTemplate:
    ...
    def test_create_with_external_constants(self):
        ...
        if self.device == "cpu":
            ...
            raise unittest.SkipTest(
                "external-constants ctor not bound on MPS runner"
            )
        else:
        ...
        # Drop runner before external_weights goes out of scope to validate
        # that user-managed lifetime works (runner does not steal ownership).
        del runner
