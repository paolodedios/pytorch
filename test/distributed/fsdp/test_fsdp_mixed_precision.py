    ...
    def test_full_precision_in_eval_buffers(self):
        ...
        for (
            ...
            def verify_eval_buffer_dtype(module, input):
                ...
                print([b for b in module.named_buffers()])
            ...
            hook_handles = []
            hook_handles.append(
                _get_underlying_module(fsdp_model[0])
                .register_forward_pre_hook(verify_eval_buffer_dtype)
            )
            hook_handles.append(
                _get_underlying_module(fsdp_model[1])
                .register_forward_pre_hook(verify_eval_buffer_dtype)
            )
