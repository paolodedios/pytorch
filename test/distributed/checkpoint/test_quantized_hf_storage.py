...
class TestQuantizedHfStorage(TestCase):
    ...
    def test_dequantization(self, mock_safe_open):
        ...
        # Verify safe_open was called for the cross-file scale tensor
        expected_scale2_path = Path(self.path) / file2_name
        mock_safe_open.assert_called_once_with(
            expected_scale2_path, framework="pt", device="cpu"
        )
