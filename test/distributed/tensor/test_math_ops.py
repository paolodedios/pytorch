...
class DistMathOpsTest(DTensorTestBase):
    ...
    def test_layer_norm_bwd_req_grad(self):
        ...
        for subtest_cfg in subtest_cfgs:
            try:
                ...
                output_dist_cmp = output_dist.full_tensor() if isinstance(output_dist, DTensor) else output_dist
    ...
    def test_partial_reduction_ops(self):
        ...
        self.assertEqual(out_without_redistribute.full_tensor(), out_with_redistribute.full_tensor())
