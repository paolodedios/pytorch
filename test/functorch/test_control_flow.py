...
class GraphModule(torch.nn.Module):
    def forward(self, L_xs_0_0_: "f32[3, 10, 2]", L_xs_0_1_0_: "f32[3, 10, 2]", L_xs_1_: "f32[3, 10, 2]"):
        ...
        _vmap_increment_nesting_in_graph = torch._functorch.vmap._vmap_increment_nesting_in_graph(1, 'error');  _vmap_increment_nesting_in_graph = None

        _add_batch_dim_in_graph: "f32[10, 2]" = torch._functorch.vmap._add_batch_dim_in_graph(child, 0, 1);  child = None
        _add_batch_dim_in_graph_1: "f32[10, 2]" = torch._functorch.vmap._add_batch_dim_in_graph(child_1, 0, 1);  child_1 = None
        _add_batch_dim_in_graph_2: "f32[10, 2]" = torch._functorch.vmap._add_batch_dim_in_graph(child_2, 0, 1);  child_2 = _add_batch_dim_in_graph_2 = None
        _add_batch_dim_in_graph_3: "f32[10, 2]" = torch._functorch.vmap._add_batch_dim_in_graph(child_3, 0, 1);  child_3 = _add_batch_dim_in_graph_3 = None
        _add_batch_dim_in_graph_4: "f32[10, 2]" = torch._functorch.vmap._add_batch_dim_in_graph(child_4, 0, 1);  child_4 = _add_batch_dim_in_graph_4 = None
        _add_batch_dim_in_graph_5: "f32[10, 2]" = torch._functorch.vmap._add_batch_dim_in_graph(child_5, 0, 1);  child_5 = None

        a: "f32[10, 2]" = _add_batch_dim_in_graph + _add_batch_dim_in_graph_5;  _add_batch_dim_in_graph = None
        b: "f32[10, 2]" = _add_batch_dim_in_graph_1 - _add_batch_dim_in_graph_5;  _add_batch_dim_in_graph_1 = _add_batch_dim_in_graph_5 = None

        child_6: "f32[10, 2]" = a - b

        child_7: "f32[1, 10, 2]" = torch._functorch.vmap._remove_batch_dim_in_graph(a, 1, 1, 0);  a = None
        child_8: "f32[1, 10, 2]" = torch._functorch.vmap._remove_batch_dim_in_graph(b, 1, 1, 0);  b = None
        child_9: "f32[1, 10, 2]" = torch._functorch.vmap._remove_batch_dim_in_graph(child_6, 1, 1, 0);  child_6 = None

        _vmap_decrement_nesting_in_graph = torch._functorch.vmap._vmap_decrement_nesting_in_graph();  _vmap_decrement_nesting_in_graph = None
        ...
        _vmap_increment_nesting_in_graph_1 = torch._functorch.vmap._vmap_increment_nesting_in_graph(1, 'error');  _vmap_increment_nesting_in_graph_1 = None

        _add_batch_dim_in_graph_6: "f32[10, 2]" = torch._functorch.vmap._add_batch_dim_in_graph(child_7, 0, 1)
        _add_batch_dim_in_graph_7: "f32[10, 2]" = torch._functorch.vmap._add_batch_dim_in_graph(child_8, 0, 1)
        _add_batch_dim_in_graph_8: "f32[10, 2]" = torch._functorch.vmap._add_batch_dim_in_graph(child_9, 0, 1);  _add_batch_dim_in_graph_8 = None
        _add_batch_dim_in_graph_9: "f32[10, 2]" = torch._functorch.vmap._add_batch_dim_in_graph(child_10, 0, 1);  child_10 = _add_batch_dim_in_graph_9 = None
        _add_batch_dim_in_graph_10: "f32[10, 2]" = torch._functorch.vmap._add_batch_dim_in_graph(child_11, 0, 1);  child_11 = _add_batch_dim_in_graph_10 = None
        _add_batch_dim_in_graph_11: "f32[10, 2]" = torch._functorch.vmap._add_batch_dim_in_graph(child_12, 0, 1);  child_12 = None

        a_1: "f32[10, 2]" = _add_batch_dim_in_graph_6 + _add_batch_dim_in_graph_11;  _add_batch_dim_in_graph_6 = None
        b_1: "f32[10, 2]" = _add_batch_dim_in_graph_7 - _add_batch_dim_in_graph_11;  _add_batch_dim_in_graph_7 = _add_batch_dim_in_graph_11 = None

        child_13: "f32[10, 2]" = a_1 - b_1

        child_14: "f32[1, 10, 2]" = torch._functorch.vmap._remove_batch_dim_in_graph(a_1, 1, 1, 0);  a_1 = None
        child_15: "f32[1, 10, 2]" = torch._functorch.vmap._remove_batch_dim_in_graph(b_1, 1, 1, 0);  b_1 = None
        child_16: "f32[1, 10, 2]" = torch._functorch.vmap._remove_batch_dim_in_graph(child_13, 1, 1, 0);  child_13 = None

        _vmap_decrement_nesting_in_graph_1 = torch._functorch.vmap._vmap_decrement_nesting_in_graph();  _vmap_decrement_nesting_in_graph_1 = None
