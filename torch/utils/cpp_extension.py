...
class BuildExtension(build_ext):
    ...
    languages (``cxx``, ``nvcc`` or ``sycl``) to a list of additional compiler flags to
    supply to the compiler. This makes it possible to supply different flags to
    the C++, CUDA and SYCL compiler during mixed compilation.
    ...
    def build_extensions(self) -> None:
        ...
        while (not cuda_ext and not sycl_ext) and extension:
