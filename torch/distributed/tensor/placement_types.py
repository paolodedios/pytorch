...
class Shard(torch._C._distributed.Shard):
    ...
    def _reduce_shard_tensor(
        ...
        return (
            ...
            .run(
                tensor,
                lambda t: funcol.reduce_scatter_single(
    ...
    def _to_replicate_tensor(
        ...
        return (
            ...
            .run(
                local_tensor,
                lambda t: funcol.all_gather_single(
...
class _StridedShard(torch._C._distributed.StridedShard):
    ...
    def _reduce_shard_tensor(
        ...
        return (
            CollectivePaddingContext(mesh, mesh_dim)
            .pad_new_strided(self.dim, tensor.size(self.dim), self._split_factor_int())
            .run(
                tensor,
    ...
    def _to_replicate_tensor(
        ...
        return (
            CollectivePaddingContext(mesh, mesh_dim)
            .pad_old_strided(
                self.dim, current_logical_shape[self.dim], self._split_factor_int()
            )
            .run(
                local_tensor,
                lambda t: funcol.all_gather_single(
