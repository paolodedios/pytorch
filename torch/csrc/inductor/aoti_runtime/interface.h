...
// Constants are passed as a flat array of ABI-stable AOTInductorConstantMapEntry
// (name -> AtenTensorHandle) rather than AOTInductorConstantMapHandle, which is
// not ABI stable across the DSO boundary.
