...
C10_UNUSED static int64_t floordiv(int64_t a, int64_t b) {
  if (b == 0) {
...
C10_UNUSED static int64_t floor(double a) {
  checkDoubleInRange(a);
  return std::floor(a);
}
C10_UNUSED static int64_t ceil(double a) {
  checkDoubleInRange(a);
  return std::ceil(a);
}

C10_UNUSED static int64_t gcd(int64_t a, int64_t b) {
  while (b != 0) {
    int64_t r = a % b;
    a = b;
    b = r;
