...
def register_graphsafe_run_with_rng_state_op():
    ...
    graphsafe_run_with_rng_state.py_impl(DispatchKey.CUDA)(_impl_graphsafe_rng)
    graphsafe_run_with_rng_state.py_impl(DispatchKey.PrivateUse1)(_impl_graphsafe_rng)
