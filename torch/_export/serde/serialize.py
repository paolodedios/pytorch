...
class GraphModuleDeserializer:
    ...
    def deserialize_multiple_outputs(self, serialized_node: Node, fx_node: torch.fx.Node) -> None:
        ...
        if len(serialized_node.outputs) == 1:
            ...
            normalized_outputs = serialized_node.outputs[0].as_tensors
        else:
            normalized_outputs = serialized_node.outputs

        meta_val = []
        generate_getitems(meta_val, fx_node, normalized_outputs)
