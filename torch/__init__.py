...
def _check(
    cond: builtins.bool | SymBool, message: _Callable[[], object] | None = None
) -> None:
...
def _check_is_size(
    i: "IntLikeType",
    message: _Callable[[], object] | None = None,
    *,
...
def _check_tensor_all(
    cond: "torch.Tensor", message: _Callable[[], object] | None = None
) -> None:
    r"""Throws error containing an optional message if the specified condition
    is False.
