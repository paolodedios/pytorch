...
class Dim:
    ...
    AUTO = _DimHint.AUTO  # hint for automatic inference of shape (static or dynamic)
    STATIC = _DimHint.STATIC  # hint for static shape (always specialized)

    def __new__(
        cls, name: str, *, min: Optional[int] = None, max: Optional[int] = None
    ):
        from torch.utils._sympy.numbers import int_oo
