...
class BaseListVariable(VariableTracker):
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        if symbolic_lengths is None:
            symbolic_lengths = []
        elif not isinstance(symbolic_lengths, list):
    ...
    def tp_iteritem_impl(
        ...
        self._check_no_symbolic_length("_tp_iteritem")
    ...
    def sq_contains(
        ...
        self._check_no_symbolic_length("__contains__")
    ...
    def call_method(
        ...
        if name == "index":
            ...
            self._check_no_symbolic_length("__reversed__")
...
class ListVariable(CommonListMethodsVariable):
    ...
    def call_method(
        ...
        if name == "__init__" and self.is_mutable():
            ...
            if len(args) == 0:
                ...
                self.items.clear()
                self.symbolic_lengths.clear()
                return self.call_method(tx, "extend", [arg], {})
    ...
    def sq_concat_impl(
        ...
        if isinstance(other, ListVariable):
            items = self.items + other.items
            symbolic_lengths = self.symbolic_lengths + other.symbolic_lengths
        else:
...
class SliceVariable(VariableTracker):
    ...
    def __init__(
        self,
        items: list[VariableTracker],
        tx: Optional["InstructionTranslatorBase"] = None,
        **kwargs: Any,
    ) -> None:
        items_to_map = items
