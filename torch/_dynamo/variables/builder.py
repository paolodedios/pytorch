...
class VariableBuilder:
    ...
    def __call__(self, value):
        ...
        def _is_deduplicable_sym_variable(value, vt):
            ...
            return (
                is_torch_sym(value) or isinstance(value, DynamicScalar)
    ...
    def _wrap(self, value):
        ...
        elif isinstance(value, DynamicScalar):
            if not self.tx.error_on_graph_break:
                raise AssertionError(
                    "DynamicInts are only compatible with fullgraph compile, please use torch.compile(fullgraph=True)"
                )
