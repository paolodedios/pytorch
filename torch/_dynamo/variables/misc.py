        ...
        if is_under_vmap:
            if self.fn_cls.generate_vmap_rule and has_custom_vmap:
                unimplemented(
                    ...
                    "staticmethod.",
                    hints=[
                        "Set `generate_vmap_rule=False` or remove the custom `vmap` staticmethod.",
            ...
            if not self.fn_cls.generate_vmap_rule:
                unimplemented(
                    ...
                    hints=[
                        "Set `generate_vmap_rule=True` if generated vmap rules are valid for this autograd.Function.",
                        *graph_break_hints.SUPPORTABLE,
                    ],
                )
