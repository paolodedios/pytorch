...
torch_c_binding_in_graph_functions = dict.fromkeys(
    [
        ...
        "torch._C._accelerator_getDeviceCapability",
        "torch._C._accelerator_getDeviceIndex",
        "torch._C._accelerator_getDeviceStats",
        "torch._C._accelerator_getMemoryInfo",
        "torch._C._accelerator_getStream",
        "torch._C._accelerator_isAllocatorInitialized",
        "torch._C._accelerator_isInBadFork",
        "torch._C._accelerator_isLazyInitialized",
        "torch._C._accelerator_maybeExchangeDevice",
        "torch._C._accelerator_resetPeakStats",
