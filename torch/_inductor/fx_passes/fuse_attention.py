...
def _sfdp_pattern_21(query, key, value, attn_mask, dropout_p):
...
def _sfdp_replacement_21(query, key, value, attn_mask, dropout_p):
    counters["inductor"]["fuse_attention"] += 1
    query = query.permute(0, 2, 1, 3)
    key = key.permute(0, 2, 1, 3)
    value = value.permute(0, 2, 1, 3)
...
def _sfdp_pattern_22(query, key, value, attn_mask, dropout_p):
...
def _sfdp_replacement_22(query, key, value, attn_mask, dropout_p):
    counters["inductor"]["fuse_attention"] += 1
    query = query.permute(0, 2, 1, 3)
    key = key.permute(0, 2, 1, 3)
    value = value.permute(0, 2, 1, 3)
...
def _sfdp_pattern_23(query, key, value, dropout_p):
...
def _sfdp_replacement_23(query, key, value, dropout_p):
    counters["inductor"]["fuse_attention"] += 1
    query = query.permute(0, 2, 1, 3)
    key = key.permute(0, 2, 1, 3)
    value = value.permute(0, 2, 1, 3)
