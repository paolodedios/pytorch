...
# Will underprune - pruning some valid configs with theoretical shared memory usage higher
# than real shared memory usage, though ensuring that invalid configs are not possibly autotuned
# Namely for configs in the exhaustive search space
