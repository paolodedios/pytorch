...
class CacheDump(TypedDict):
    ...
    Attributes:
        ...
        cache_size: The number of top-level entries in cache_entries.
    """
...
class Memoizer(_BaseMemoizer):
    ...
    def __del__(self) -> None:
        """Destructor that dumps the cache to disk when the instance is garbage collected."""
    ...
    def _prepare_dump(self, existing_dump: CacheDump | None) -> CacheDump:
        ...
        # Update cache size
        dump["cache_size"] = len(dump["cache_entries"])
