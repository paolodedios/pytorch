    ...
    def codegen_and_compile(
        ...
        with (
            ...
            with dynamo_timed(
                ...
                # graph.
                with torch.no_grad():
                    # Save input devices before fake_tensor_prop
                    # in case shallow_copy_data_ mutates them.
                    # Unlike make_fx, fake_tensor_prop does not use
                    # snapshot_fake so in-place device mutations
                    # corrupt the inputs.
                    orig_input_devices = [
