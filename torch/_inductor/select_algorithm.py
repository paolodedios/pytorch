...
class AlgorithmSelectorCache(PersistentCache):
    ...
    def __call__(
        ...
        if return_multi_template and (config.max_autotune or config.max_autotune_gemm):
            ...
            def get_timings(hint_override: Optional[int] = None):
                ...
                timings = self.do_autotuning(
                    name, input_nodes, layout, input_gen_fns, inputs_key, filtered_choices, precompile_fn, hint_override=hint_override, best_config_future=best_config_future
                )
        ...
        timings = self.do_autotuning(name, input_nodes, layout, input_gen_fns, inputs_key, choices, precompile_fn, best_config_future=best_config_future)
    ...
    def benchmark(self, choices, input_nodes, layout, input_gen_fns, hint_override: Optional[int] = None):
    ...
    def autotune(self, name, input_nodes, choices, hint_override: Optional[int] = None):
        ...
        with dynamo_timed(
            ...
            benchmark_results = self.benchmark(choices, hint_override=hint_override)
    ...
    def do_autotuning(self, name, input_nodes, layout, input_gen_fns, inputs_key, choices, precompile_fn, hint_override: Optional[int] = None, best_config_future=None):
        ...
        if candidates:
            ...
            timings = self.lookup(
                ...
                name,
                inputs_key,
                lambda choices: self.autotune(name, input_nodes, choices, hint_override=hint_override),
                hint_override=hint_override,
            )
        ...
        def track_has_autotuned(choices):
            ...
            has_autotuned = True
            return self.autotune(name, input_nodes, choices, hint_override=hint_override)
