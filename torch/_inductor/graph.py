...
class GraphLowering(torch.fx.Interpreter):
    ...
    def get_placeholder_sizes_strides(
        ...
        # Use _get_placeholder_expr for sizes so input-tensor dimensions carry
        # the raw (pre-replacement) symbol from the FakeTensor.  This way each
        ...
        # resolve to defined variables.  Strides use post-replacement .expr
        # since they can be compound expressions that codegen can't bind.
        #
        ...
        def size_to_expr(i: int | torch.SymInt) -> int | Expr:
        ...
        return [size_to_expr(i) for i in size], [sympy.sympify(i) for i in stride]
